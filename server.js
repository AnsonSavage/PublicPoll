...
const tickets = require("./polls.js"); //We want to use the poll.js file in our current directory.
app.use("/api/polls", polls.js); //Thus, if we get any path starting with /api/polls, we know we should use the poll.js code